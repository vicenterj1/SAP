class ZCL_ZOV_VICENTE_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ZFI_ATUALIZA_STATUS,
        ID_ORDEMID type I,
        ID_SATUS type C length 1,
    end of TS_ZFI_ATUALIZA_STATUS .
  types:
    begin of TS_ZFI_ATUALIZA_STATUS_COMPLX,
        ID_STATUS type C length 1,
        ID_ORDEMID type I,
    end of TS_ZFI_ATUALIZA_STATUS_COMPLX .
  types:
  begin of TS_OVCAB,
     ORDEMID type I,
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZOV_VICENTE_MPC===========CP' ##NO_TEXT.
...
CLASS ZCL_ZOV_VICENTE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZOV_VICENTE_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_VICENTE_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_VICENTE_MPC=>TS_OVCAB' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_VICENTE_MPC=>TS_OVITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20241123184407'.                  "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'ID_SATUS'    iv_abap_fieldname = 'ID_SATUS' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_parameter->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZOV_VICENTE_MPC=>TS_ZFI_ATUALIZA_STATUS' ). "#EC NOTEXT
***********************************************************************************************************************************
*   ACTION - zfi_atualiza_status_complx
***********************************************************************************************************************************

lo_action = model->create_action( 'zfi_atualiza_status_complx' ).  "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'id_ordemid'    iv_abap_fieldname = 'ID_ORDEMID' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_int32( ).
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZOV_VICENTE_MPC=>TS_ZFI_ATUALIZA_STATUS_COMPLX' ). "#EC NOTEXT
  endmethod.
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name = 'ZCL_ZOV_VICENTE_MPC=>MENSAGEM2' ). "#EC NOTEXT
  endmethod.
ENDCLASS.
