		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vicenteaprovacaosolicitacaoaprovacaosolicitacao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vicenteaprovacaosolicitacaoaprovacaosolicitacao-display": {
								"semanticObject": "vicenteaprovacaosolicitacaoaprovacaosolicitacao",
								"action": "display",
								"description": "Ação Urgente - VICENTE",
								"title": "Ação Urgente - VICENTE",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vicente.aprovacaosolicitacao.aprovacaosolicitacao",
									"url": sap.ui.require.toUrl("vicente/aprovacaosolicitacao/aprovacaosolicitacao")
								}
							}
						}
					}
